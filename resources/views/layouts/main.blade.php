...
<body class="bg-primary-blue">
    <nav>
        <div class="container mx-auto flex items-center justify-between px-16 py-6">
            <ul class="flex items-center text-white text-sm gap-x-24">
                <li class="mr-20">
                    <a href="#">
            ...
            <div class="flex items-center">
                <div class="relative">
                    <input 
                        type="text" 
                        class="bg-white rounded-full w-64 pl-8 px-4 py-1.5 text-xs focus:ring-2 focus:ring-light-orange focus:outline-none"
