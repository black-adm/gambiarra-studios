...
@section('content')
    <div>
        <div class="container flex mx-auto px-6 py-20">
            <img 
            ...
            <div class="ml-12 mt-1">
                <h2 class="text-4xl font-semibold text-primary-orange">
                    Matrix Resurrections <strong class="text-white">(2021)</strong>
                </h2>

                    <div class="flex items-center text-white text-sm mt-2 gap-x-1">
                        ...
                        <p class="flex items-center gap-x-2">
                            <svg class="w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-calendar-days"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/><path d="M8 14h.01"/><path d="M12 14h.01"/><path d="M16 14h.01"/><path d="M8 18h.01"/><path d="M12 18h.01"/><path d="M16 18h.01"/></svg>
                            22 de Dezembro de 2021
                        </p>
                        
                        <span class="mx-2">|</span>
                        <p class="flex items-center gap-x-2">
                            <svg class="w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-info"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>
                            Ação, Suspense e Romance
                        </p>
                    </div>   

                    <p class="mt-10 md:w-[40rem] text-white font-light">
